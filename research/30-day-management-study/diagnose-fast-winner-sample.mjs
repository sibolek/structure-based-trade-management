...
console.log("================================================================================");
console.log("Use this output to recover an independently defensible definition of 'fast winners' and any plausible stratification. Do not select 19 trades solely because their realized P/L sums to +$86.46. The preserved counterfactual/MFE fingerprint can be used later as validation after a selection rule is established.");

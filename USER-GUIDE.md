...
Serialize already-authored analysis and package it in the standard Downloads location (if the transport already exists, run only the package command with its actual path):
